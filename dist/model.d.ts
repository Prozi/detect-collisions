...
type SATTestTemplate<T extends Body, Y extends Body> = (a: T, b: Y, r: Response) => boolean;
/**
 * test function from sat.js type
 */
export type SATTest = SATTestTemplate<Circle, Polygon> | SATTestTemplate<Circle, Circle> | SATTestTemplate<Polygon, Polygon> | SATTestTemplate<Polygon, Circle>;
